    ...
    <div class="box-card  secondBox">
        ...
        <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)"
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <span style="color:#409EFF;cursor: pointer;" @click="dialogTableVisible = true">查看</span>
      ...
      <el-row :gutter="20">  
        <el-col :span="14" :offset="1">
              <el-row :gutter="20">
                <el-col :span="6" >
                  <div >
                      <el-button  @click="onSubmit" >报送</el-button>
                  </div>
                </el-col>
                <el-col :span="6" :offset="1">
                  <div >
                      <el-button  @click="onSubmit" >删除</el-button>
                  </div>
                </el-col>
              </el-row>
          </el-col>
...
<script>
import { notFound } from '@/api/dataSubmitAjax'
export default {
  data() {
    return {
      // 第一大块变量开始
  ...
  methods: {
    ...
    fetchData(listQuery) {
      ...
      notFound(this.listQuery).then(response => {
...
.notFound .alertBox .el-form-item--small.el-form-item {
    margin-bottom: 10px;
}
.notFound .alertBox{
  /* position: relative; */
...
.notFound  .detailBox p{
    margin: 6px 0;
}
.notFound .el-dialog__body{
  padding: 0 20px;
}
.notFound   .coverScroll{
  height: 50vh;
  width: 20px;
  background:#fff;
  position: absolute;
